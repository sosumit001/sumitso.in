---
title: "A Cartoon Intro: Building React from Scratch"
...
You've already seen the title, so in this tutorial, I'll explain what is required to build a React client application from scratch—an application that doesn't rely on tools like `create-react-app` or other developer aids like `vite` or `parcel`.
